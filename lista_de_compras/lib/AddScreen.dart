...
class AddOverlay extends StatefulWidget {
  ...
  @override
  AddOverlay(int nextID){
    nextAudio = nextID;
  }

  AddItemOverlay createState() => AddItemOverlay(nextAudio);
}

class AddItemOverlay extends State<AddOverlay> {
  ...
  AddItemOverlay(int nextID){
    nextAudio = nextID;
    recorder = new AudioRecorder(nextID);
  }

  @override
  initState(){
    _img = PickedFile("");
    _videoController = new VideoPlayerController.file(File(""));
    super.initState();
  }//end of contructor
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: addButton(nome, descricao, context),
      appBar: AppBar(
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text("Imagem do Item", style: TextStyle(
              ...
              Padding(
                padding: EdgeInsets.all(10),
                child: Text("Vídeo do Item", style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                ),),
              ),
              ...
              Padding(
                padding: EdgeInsets.all(10),
                child: Text("Audio do Item", style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                ),),
              ),
  ...
  addButton(TextEditingController nome, TextEditingController descricao, BuildContext context){
    return Container(
      margin: EdgeInsets.only(top: 10.0, bottom: 20),
      height: 45,
      child: RaisedButton(
        ...
        Icon(Icons.add),
        onPressed: () {
          if(nome.text.length > 0 && descricao.text.length > 0){
            setState(() {
              String video = "";
              String image = "";
              ...
              Criavel criavel = new Criavel();
              criavel.item = new Item(nome.text, descricao.text, image,
                  video, recorder.recordFilePath);
              criavel.nextID = recorder.fileNumber;
              Navigator.pop(context, criavel);
            });
          }//end of if
        },
      ),
